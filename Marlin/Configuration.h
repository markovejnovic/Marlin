...
#define CONFIG_EXAMPLES_DIR "config/examples/Creality/Ender-5 Plus"
...
#define STRING_CONFIG_H_AUTHOR "(mvejnovic, Creality Ender-5 Plus)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Hacked E5+"
